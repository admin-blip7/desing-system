...
const fileMap = {
  ...
  "resume.baml": "function GenerateText(prompt: string, system_prompt: string, force_json: bool) -> string {\n  client CustomGPT5Mini\n  prompt #\"\n    System instructions:\n    {{ system_prompt }}\n\n    User prompt:\n    {{ prompt }}\n\n    {% if force_json %}\n    IMPORTANT: Return valid JSON only. Do not include markdown or extra prose.\n    {% endif %}\n  \"#\n}\n\ntest generate_text {\n  functions [GenerateText]\n  args {\n    prompt \"Generate a JSON object with key status\"\n    system_prompt \"You are a strict JSON assistant\"\n    force_json true\n  }\n}\n",
}
